...
interface ICompliance {
    ...
    *  @param _tokenId The token id involved in the transfer
    */
    function canTransfer(address _from, address _to, uint256 _tokenId) external view returns (bool);
    ...
    *  @param _tokenId The token id involved in the transfer
    */
    function created(address _to, uint256 _tokenId) external;
    ...
    *  @param _tokenId The token id involved in the transfer
    */
    function destroyed(address _from, uint256 _tokenId) external;
